...
const MarketPlaceComp = ({data , bgColor}) => {
  return (
    <div className="bg-[rgb(43,43,43)] flex flex-col justify-center items-center  py-20" >
  ...
  <div className='flex flex-col justify-center items-center w-[60%]'>
    ...
    <div className="flex gap-4 text-gray-500 text-2xl w-full">
              ...
              <button value='NFT' className="p-5  px-10 flex gap-3 items w-[50%] justify-center  focus:text-white focus:border-b-2 border-gray-500" >NFTs
                 <h1 className="bg-gray-500 text-white rounded-full py-1 px-2 text-sm">333</h1>
              </button>
        
         
              <button value='collection' className="p-5 px-10 flex gap-3 items justify-center  w-[50%] focus:text-white focus:border-b-2 border-gray-500" >Collections
