    ...
    <>
          ...
          <hr className=" w-[100%] h-px border-t-0 bg-transparent bg-gradient-to-r  from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100" />
            ...
            <div className="flex gap-4 text-gray-500 text-2xl w-full">
              ...
              >
                NFTs
                <h1 className="bg-gray-500 text-white items-center flex rounded-full py-1 px-2 text-sm">
                  333
                </h1>
              </button>
              ...
              >
                Collections
                <h1 className="bg-gray-500 text-white flex items-center rounded-full py-1 px-2 text-sm">
                  346
                </h1>
              </button>
            </div>
