...
const Marketplace = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center w-[60%]'>
      ...
      <div className="flex gap-4 text-white text-2xl w-full">

      
                <button className="p-5 px-10 flex gap-3 items w-[50%] justify-center" >NFTs
                   <h1 className="bg-gray-500 rounded-full py-1 px-2 text-sm">333</h1>
                </button>
          
           
                <button className="p-5 px-10 flex gap-3 items justify-center  w-[50%]" >Collections
                   <h1 className="bg-gray-500 rounded-full py-1 px-2 text-sm">346</h1>
                </button>
